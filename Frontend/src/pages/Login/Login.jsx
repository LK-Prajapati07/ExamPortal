...
const Login = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const responce=await signInWithEmailAndPassword(email,password)
            ...
            <div className="rounded-3xl border border-gray-100 bg-white p-8 shadow-xl shadow-blue-100/40">
              ...
              >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full rounded-xl border bg-gray-50 py-3.5 pl-11 pr-4 outline-none transition focus:bg-white focus:ring-4 focus:ring-blue-100 ${
                        errors.email
                          ? "border-red-500"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full rounded-xl border bg-gray-50 py-3.5 pl-11 pr-12 outline-none transition focus:bg-white focus:ring-4 focus:ring-blue-100 ${
                        errors.password
                          ? "border-red-500"
                          : "border-gray-200 focus:border-blue-500"
                      }`}
                ...
                <button
                  ...
                  className="w-full rounded-xl bg-blue-600 py-3.5 font-semibold text-white transition hover:bg-blue-700 hover:shadow-lg hover:shadow-blue-200 disabled:cursor-not-allowed disabled:opacity-70"
                >
